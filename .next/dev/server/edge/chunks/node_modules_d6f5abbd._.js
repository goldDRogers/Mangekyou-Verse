(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push(["chunks/node_modules_d6f5abbd._.js",
...
function createSupabaseClient(supabaseUrl, supabaseKey, options) {
    ...
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$supabase$2f$supabase$2d$js$2f$dist$2f$index$2e$mjs__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createClient"])(supabaseUrl, supabaseKey, {
        ...options,
        auth: {
            flowType: "pkce",
...
var supabase;
function createClientComponentClient({ supabaseUrl = ("TURBOPACK compile-time value", "https://vwulumetavfznwqgfxmy.supabase.co"), supabaseKey = ("TURBOPACK compile-time value", "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InZ3dWx1bWV0YXZmem53cWdmeG15Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3Njg1NTE3NzYsImV4cCI6MjA4NDEyNzc3Nn0.kpul5ZoM8N0njblCPTbikQTMJ4nGFSchfODP6hp__ew"), options, cookieOptions, isSingleton = true } = {}) {
...
function createPagesServerClient(context, { supabaseUrl = ("TURBOPACK compile-time value", "https://vwulumetavfznwqgfxmy.supabase.co"), supabaseKey = ("TURBOPACK compile-time value", "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InZ3dWx1bWV0YXZmem53cWdmeG15Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3Njg1NTE3NzYsImV4cCI6MjA4NDEyNzc3Nn0.kpul5ZoM8N0njblCPTbikQTMJ4nGFSchfODP6hp__ew"), options, cookieOptions } = {}) {
    var _a;
    if (!supabaseUrl || !supabaseKey) {
        throw new Error("either NEXT_PUBLIC_SUPABASE_URL and NEXT_PUBLIC_SUPABASE_ANON_KEY env variables or supabaseUrl and supabaseKey are required!");
    }
...
function createMiddlewareClient(context, { supabaseUrl = ("TURBOPACK compile-time value", "https://vwulumetavfznwqgfxmy.supabase.co"), supabaseKey = ("TURBOPACK compile-time value", "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InZ3dWx1bWV0YXZmem53cWdmeG15Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3Njg1NTE3NzYsImV4cCI6MjA4NDEyNzc3Nn0.kpul5ZoM8N0njblCPTbikQTMJ4nGFSchfODP6hp__ew"), options, cookieOptions } = {}) {
    var _a;
    if (!supabaseUrl || !supabaseKey) {
        throw new Error("either NEXT_PUBLIC_SUPABASE_URL and NEXT_PUBLIC_SUPABASE_ANON_KEY env variables or supabaseUrl and supabaseKey are required!");
    }
...
function createServerComponentClient(context, { supabaseUrl = ("TURBOPACK compile-time value", "https://vwulumetavfznwqgfxmy.supabase.co"), supabaseKey = ("TURBOPACK compile-time value", "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InZ3dWx1bWV0YXZmem53cWdmeG15Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3Njg1NTE3NzYsImV4cCI6MjA4NDEyNzc3Nn0.kpul5ZoM8N0njblCPTbikQTMJ4nGFSchfODP6hp__ew"), options, cookieOptions } = {}) {
    var _a;
    if (!supabaseUrl || !supabaseKey) {
        throw new Error("either NEXT_PUBLIC_SUPABASE_URL and NEXT_PUBLIC_SUPABASE_ANON_KEY env variables or supabaseUrl and supabaseKey are required!");
    }
...
function createRouteHandlerClient(context, { supabaseUrl = ("TURBOPACK compile-time value", "https://vwulumetavfznwqgfxmy.supabase.co"), supabaseKey = ("TURBOPACK compile-time value", "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InZ3dWx1bWV0YXZmem53cWdmeG15Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3Njg1NTE3NzYsImV4cCI6MjA4NDEyNzc3Nn0.kpul5ZoM8N0njblCPTbikQTMJ4nGFSchfODP6hp__ew"), options, cookieOptions } = {}) {
    var _a;
    if (!supabaseUrl || !supabaseKey) {
        throw new Error("either NEXT_PUBLIC_SUPABASE_URL and NEXT_PUBLIC_SUPABASE_ANON_KEY env variables or supabaseUrl and supabaseKey are required!");
    }
...
// src/deprecated.ts
function createBrowserSupabaseClient({ supabaseUrl = ("TURBOPACK compile-time value", "https://vwulumetavfznwqgfxmy.supabase.co"), supabaseKey = ("TURBOPACK compile-time value", "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InZ3dWx1bWV0YXZmem53cWdmeG15Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3Njg1NTE3NzYsImV4cCI6MjA4NDEyNzc3Nn0.kpul5ZoM8N0njblCPTbikQTMJ4nGFSchfODP6hp__ew"), options, cookieOptions } = {}) {
...
function createServerSupabaseClient(context, { supabaseUrl = ("TURBOPACK compile-time value", "https://vwulumetavfznwqgfxmy.supabase.co"), supabaseKey = ("TURBOPACK compile-time value", "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InZ3dWx1bWV0YXZmem53cWdmeG15Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3Njg1NTE3NzYsImV4cCI6MjA4NDEyNzc3Nn0.kpul5ZoM8N0njblCPTbikQTMJ4nGFSchfODP6hp__ew"), options, cookieOptions } = {}) {
...
function createMiddlewareSupabaseClient(context, { supabaseUrl = ("TURBOPACK compile-time value", "https://vwulumetavfznwqgfxmy.supabase.co"), supabaseKey = ("TURBOPACK compile-time value", "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InZ3dWx1bWV0YXZmem53cWdmeG15Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3Njg1NTE3NzYsImV4cCI6MjA4NDEyNzc3Nn0.kpul5ZoM8N0njblCPTbikQTMJ4nGFSchfODP6hp__ew"), options, cookieOptions } = {}) {
...
//# sourceMappingURL=node_modules_d6f5abbd._.js.map