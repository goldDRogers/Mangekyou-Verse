...
const getApiKey = ()=>{
    try {
        // @ts-ignore
        return typeof process !== 'undefined' && process.env?.GEMINI_API_KEY || __TURBOPACK__import$2e$meta__.env?.VITE_GEMINI_API_KEY || '';
    } catch (e) {
        return '';
    }
};
...
function HomePage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        const fetchData = async ()=>{
            try {
                const data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$geminiService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["generateAnimeList"])(8);
                setAnimeList(data);
            } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__6fe24cab._.js.map